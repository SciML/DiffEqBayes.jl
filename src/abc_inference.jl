function createabcfunction(
        prob, t, distancefunction, alg; save_idxs = nothing,
        sample_u0 = false, kwargs...
    )
    return function simfunc(params, constants, data)
        local u0
        if sample_u0
        ...
        sol = solve(
            prob, alg, u0 = u0, p = params, saveat = t, save_idxs = save_idxs,
            kwargs...
        )
