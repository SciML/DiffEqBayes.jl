...
function stan_inference(prob::DiffEqBase.DEProblem,t,data,priors = nothing;alg=:rk45,
                            ...
                            sample_u0 = false, save_idxs = nothing, diffeq_string = nothing, printsummary = false, summary = true)
  ...
  return_code, chains, cnames = CmdStan.stan(stanmodel, [parameter_estimation_data]; CmdStanDir=CMDSTAN_HOME, summary=summary)
