...
@test mean(bayesian_result.chains.theta_1) ≈ 1.5 atol = 3.0e-1
...
@test mean(bayesian_result2.chains.theta_1) ≈ 1.5 atol = 3.0e-1
...
@test mean(bayesian_result.chains.theta_1) ≈ 1.0 atol = 3.0e-1
@test mean(bayesian_result.chains.theta_2) ≈ 1.0 atol = 3.0e-1
@test mean(bayesian_result.chains.theta_3) ≈ 1.5 atol = 3.0e-1
...
@test mean(bayesian_result.chains.theta_1) ≈ 1.0 atol = 3.0e-1
@test mean(bayesian_result.chains.theta_2) ≈ 1.5 atol = 3.0e-1
...
@test mean(bayesian_result.chains.theta_1) ≈ 1.5 atol = 1.0e-1
@test mean(bayesian_result.chains.theta_2) ≈ 1.0 atol = 1.0e-1
@test mean(bayesian_result.chains.theta_3) ≈ 3.0 atol = 1.0e-1
@test mean(bayesian_result.chains.theta_4) ≈ 1.0 atol = 1.0e-1
