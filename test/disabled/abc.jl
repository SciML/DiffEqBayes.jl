...
data = convert(Array, randomized)
priors = [
    truncated(Normal(1.5, 1), 0, 2), truncated(Normal(1.0, 1), 0, 1.5),
...
@test meanvals[1] ≈ 1.5 atol = 3.0e-1
@test meanvals[2] ≈ 1.0 atol = 3.0e-1
@test meanvals[3] ≈ 3.0 atol = 3.0e-1
@test meanvals[4] ≈ 1.0 atol = 3.0e-1
