...
bayesian_result = turing_inference(prob1,Tsit5(),t,data,priors;num_samples=500)
theta1 = bayesian_result[:theta1][50:end]
theta2 = bayesian_result[:theta2][50:end]
theta3 = bayesian_result[:theta3][50:end]
theta4 = bayesian_result[:theta4][50:end]
@test mean(theta1) ≈ 1.5 atol=1e-1
@test mean(theta2) ≈ 1.0 atol=1e-1
@test mean(theta3) ≈ 3.0 atol=1e-1
@test mean(theta4) ≈ 1.0 atol=1e-1
